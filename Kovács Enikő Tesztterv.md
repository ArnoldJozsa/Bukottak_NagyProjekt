...
| Vizsgálat | Tesztelés időpontja | Elvárás | Eredmény | Hibák |
| :---: | --- | --- | --- | --- |
| Regisztráció | 2022.11.06. | A felhasználó sikeresen regisztráljon. | A regisztráció sikeresen működik. | Nincs hiba. |
...
| Vizsgálat | Tesztelés időpontja | Elvárás | Eredmény | Hibák |
| :---: | --- | --- | --- | --- |
| Regisztráció | 2022.11.06. | A felhasználó sikeresen regisztráljon. | Minden funkció megfelelően működik. | Nincs hiba. |
